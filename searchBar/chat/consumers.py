...
# from django.core import serializers                       //Not cosodering 
...
class ChatConsumer(AsyncJsonWebsocketConsumer):
    ...
    async def join_room(self, room_id):
        ...
        #     "title": room.title,
        # })
        # await self.load_chat(room_id)   // This is used to load data(chat) after joingroup
    ...
    #     """
    #     Called by join_room when someone joins a room, to load previous chats.
    #     """
